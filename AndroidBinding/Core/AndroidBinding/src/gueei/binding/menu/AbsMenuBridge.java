...
public abstract class AbsMenuBridge {
	...
	// Factory method
	public static AbsMenuBridge create(String nodeName, int id, AttributeSet attrs, Context context, Object model) {
		AbsMenuBridge item;
	...
	protected IObservable<?> getObservableFromStatement(Context context, AttributeSet attributes, String attrName, Object model) {
		return getObservableFromStatement(context, attributes, attrName, model, null);
	}

	protected IObservable<?> getObservableFromStatement(Context context, AttributeSet attributes, String attrName, Object model, IMenuItemChangedCallback callback) {
	...
	private class OptionsItemObserver implements Observer {
		...
		public void onPropertyChanged(IObservable<?> prop, Collection<Object> initiators) {
			if (initiators.contains(AbsMenuBridge.this))
				return;

...
/**
 * Mock menu item act as bridging bindable attributes with the real menu item Will not keep reference to real menu item since menu item might suddenly detached
 * 
 * @author andy
 * 
 */
public class MenuItemBridge extends AbsMenuBridge {
	...
	public MenuItemBridge(int id, AttributeSet attributes, Context context, Object model) {
		this(id, attributes, context, model, null);
	}

	public MenuItemBridge(int id, AttributeSet attributes, Context context, Object model, IMenuItemChangedCallback callback) {
		super(id);

...
public class MenuGroupBridge extends AbsMenuBridge {
	...
	public MenuGroupBridge(int id, AttributeSet attributes, Context context, Object model) {
		this(id, attributes, context, model, null);
	}

	@SuppressWarnings("unchecked")
	public MenuGroupBridge(int id, AttributeSet attributes, Context context, Object model, IMenuItemChangedCallback callback) {
		super(id);

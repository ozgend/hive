...
public class EventAggregator {
	private static WeakHashMap<Context, EventAggregator>	instances	= new WeakHashMap<Context, EventAggregator>();
	...
	public void publish(final String eventName, final Object publisher, final Bundle data) {
		...
		for (int i = 0; i < count; i++) {
			...
			if (subscriber != null)
				subscriber.onEventTriggered(eventName, publisher, data);
		}
	}

...
public class ArrayListObservable<T> extends ObservableCollection<T> implements List<T>, Parcelable {
	...
	public T remove(int index) {
		CollectionChangedEventArg e = new CollectionChangedEventArg(Action.Remove, Arrays.asList(new Object[] { mArray.get(index) }), index);
	...
	public static final Parcelable.Creator<ArrayListObservable<?>>	CREATOR	= new Parcelable.Creator<ArrayListObservable<?>>() {

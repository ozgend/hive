...
public class SingletonAdapter implements Adapter, SpinnerAdapter, Observer, ListAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (mView == null) {
			mView = Binder.bindView(mContext, Binder.inflateView(mContext, mTemplate.getDefaultLayoutId(), parent, false), mObj);
		}
		return mView;
	}
	...
	public View getDropDownView(int position, View convertView, ViewGroup parent) {
		if (mDropDownView == null) {
			mDropDownView = Binder.bindView(mContext, Binder.inflateView(mContext, mDropDownTemplate.getDefaultLayoutId(), parent, false), mObj);
		}

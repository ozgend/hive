...
/**
 * Provide a nested relation of adapters It is designed to use in ExpandableList
 * 
 * @author andy
 * 
 */
public class ExpandableCollectionAdapter extends BaseExpandableListAdapter implements CollectionObserver {
	...
	/*
	 * public ExpandableCollectionAdapter(Context context, IObservableCollection<?> collection, int layoutId, int dropDownLayoutId, String childName, int childLayoutId) throws
	 * Exception { mChildName = childName; mChildLayoutId = childLayoutId; mContext = context; mGroupAdapter = new CollectionAdapter(context, collection, layoutId,
	 * dropDownLayoutId); }
	 */

...
public class PojoViewModelWrapper<T extends PojoViewModel> implements IPropertyContainer {
	...
	private final Hashtable<String, PojoObservable<?>>	observables	= new Hashtable<String, PojoObservable<?>>();

	private final Hashtable<String, PojoCommand>		commands	= new Hashtable<String, PojoCommand>();
	...
	private class PojoObservable<To> extends Observable<To> {
		...
		@Override
		protected void doSetValue(To newValue, Collection<Object> initiators) {

...
public class CompoundDrawableViewAttribute extends ViewAttribute<TextView, Object> {
	...
	protected void doSetAttributeValue(Object newValue) {
		...
		if (attributeName.equals("drawableLeft")) {
			getView().setCompoundDrawablesWithIntrinsicBounds(mValue, getView().getCompoundDrawables()[1], getView().getCompoundDrawables()[2], getView().getCompoundDrawables()[3]);
		} else if (attributeName.equals("drawableTop")) {
			getView().setCompoundDrawablesWithIntrinsicBounds(getView().getCompoundDrawables()[0], mValue, getView().getCompoundDrawables()[2], getView().getCompoundDrawables()[3]);
		} else if (attributeName.equals("drawableRight")) {
			getView().setCompoundDrawablesWithIntrinsicBounds(getView().getCompoundDrawables()[0], getView().getCompoundDrawables()[1], mValue, getView().getCompoundDrawables()[3]);
		} else if (attributeName.equals("drawableBottom")) {
			getView().setCompoundDrawablesWithIntrinsicBounds(getView().getCompoundDrawables()[0], getView().getCompoundDrawables()[1], getView().getCompoundDrawables()[2], mValue);
		}
	}

...
public class ItemTemplateViewAttribute extends ViewAttribute<View, Layout> {
	...
	public ItemTemplateViewAttribute(View view, String attributeName) {
	...
	protected BindingType AcceptThisTypeAs(Class<?> type) {
		if (Integer.class.isAssignableFrom(type) || CharSequence.class.isAssignableFrom(type))
			return BindingType.OneWay;
		if (Layout.class.isAssignableFrom(type))

...
public class ExpandableListView_ItemSourceViewAttribute extends ViewAttribute<ExpandableListView, Object> {
	...
	public ExpandableListView_ItemSourceViewAttribute(ExpandableListView view) {
	...
	private void createAdapter() {
		...
		try {
			...
			Adapter groupAdapter = gueei.binding.collections.Utility.getSimpleAdapter(getView().getContext(), mValue, template, template, null);
			ExpandableCollectionAdapter adapter = new ExpandableCollectionAdapter(getView().getContext(), groupAdapter, childItemSource, childItemTemplate);

...
public class CheckedItemPositionViewAttribute extends ViewAttribute<ListView, Integer> implements OnItemClickListener, Observer {
	...
	protected void doSetAttributeValue(Object newValue) {
		...
		if (!(newValue instanceof Integer))
			return;
		if (getView().getChoiceMode() != ListView.CHOICE_MODE_SINGLE)
			return;

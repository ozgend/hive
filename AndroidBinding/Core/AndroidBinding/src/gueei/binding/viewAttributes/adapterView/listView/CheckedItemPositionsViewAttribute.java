...
public class CheckedItemPositionsViewAttribute extends ViewAttribute<ListView, SparseBooleanArray> implements OnItemClickListener {
	...
	protected void doSetAttributeValue(Object newValue) {
		...
		if (getView().getChoiceMode() != ListView.CHOICE_MODE_MULTIPLE)
			return;

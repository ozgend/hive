...
/**
 * User: =ra= Date: Dec 14, 2011 Time: 1:37:15 PM
 */
public class ClickActionPositionViewAttribute extends ViewAttribute<AdapterView<?>, Integer> implements OnItemClickListener, AdapterView.OnItemLongClickListener {

...
public abstract class ViewEventAttribute<T extends View> extends ViewAttribute<T, Command> {
	...
	/**
	 * Child should implement this and register itself to the respective Multicast listener by calling: BinderV30.getMulticastListener(view, listenerType).register(this);
	 * 
	 * @param view
	 */

...
/**
 * Converter to perform logical AND operation. It allows 1 or more arguments, if any argument is false, then it will be false
 * 
 * @usage arg arg ...
 * 
 * @arg arg boolean
...
public class AND extends Converter<Boolean> {
	...
	public boolean ConvertBack(Object value, Object[] outResult) {
		if ((!(value instanceof Boolean)) || (outResult.length < 1))
			return false;

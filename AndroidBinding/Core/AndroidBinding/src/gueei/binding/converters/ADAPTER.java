...
/**
 * ADAPTER accepts only one argument, and it must be DynamicObject It will return a simple adapter, the same parameters to gueei.binding.collections.Utility.getSimpleAdapter:
 * 
 * @usage params
 * 
	...
	public Adapter calculateValue(Object... args) throws Exception {
		try {
			...
			if (!object.observableExists("template"))
				return null;
			if (!object.observableExists("source"))
				return null;

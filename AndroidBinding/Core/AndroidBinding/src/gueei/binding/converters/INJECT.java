 ...
 * "INJECT(@android:layout/simple_list_item1, { id=@android:id/textview1, attr='text', statement='Name' }, { id=@android:id/textview1, attr='backgroundColor', statement='ARGB(255,0,0)' })"
 * <br/>
 * 
 * @usage layout params ...
 * 
...
public class INJECT extends Converter<Layout> {
	...
	public Layout calculateValue(Object... args) throws Exception {
		if (args.length < 1 || !(args[0] instanceof Layout))
			return null;
		if (args.length < 2)
			return (Layout) args[0];

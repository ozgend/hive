...
/**
 * Trigger the provided animation after the command is executed. This is NOT compatible with the newer Property-based animation
 * 
...
public class AFTERCOMMAND extends Converter<AnimationTrigger> implements CommandListener {
	...
	/**
	 * this Requires three input 1. Animation Id 2. Any Command 3. Boolean Condition (Optional, if ignore, assume True)
	 */
	@Override
	public AnimationTrigger calculateValue(Object... args) throws Exception {
		...
		if ((mCommand == null) || (!mCommand.equals(args[1])))
			if (args[1] instanceof Command) {
				if (mCommand != null)
					mCommand.removeCommandListener(this);

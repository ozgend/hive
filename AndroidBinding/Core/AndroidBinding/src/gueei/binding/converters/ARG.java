...
/**
 * Passing extra arguments to command. Since command's invoke is invoke(View, args), by using this, it will shift the original args to right, so that the extra arguments supplied
 * will always be the first few arguments when command is invoked. <br/>
 * For example, if you bind onChecked="Fire", your Fire command will receive (View, boolean) (the same as
 * http://developer.android.com/reference/android/widget/CompoundButton.OnCheckedChangeListener.html) <br/>

...
/**
 * Covert to Color value of three components or four components If only three arguments specified, color will be RGB if four arguments provided, color will be ARGB
 * 

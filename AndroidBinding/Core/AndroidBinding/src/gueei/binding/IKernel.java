...
public interface IKernel {
	/**
	 * Get the required attribute for the supplied view. This is done internally using the "tag" of the view so the attribute id must be using the Android id resource type
	 * 
	 * @param view
	 * @param attributeId
	 *            must be attribute defined in id type Resource
	 * @return
	...
	/**
	 * Get the associated View Tag of a view, if view tag is not existed or the existing tag is not view tag, a new viewTag will be created and return.
	 * 
	 * @param view
	 * @return
	 */
	 ...
	 * @param context
	 * @param layoutId
	 *            The xml layout declaration
	 * @param parent
	 *            Parent view of the group, just pass null in most cases
	 * @param attachToRoot
	 *            Pass false
	 ...
	 * @param context
	 * @param inflatedView
	 *            The inflated result from inflateView
	 * @param model
	 *            The view model that is going to bind to

...
public class Utility {
	...
	/**
	 * Evaluate the value of the provided item If it is a plain item, it's value is returned, if it is an Observable, it's get() is returned
	 * 
	 * @param item
	 * @return
	 */
	...
	public static <T> T evalValue(Object item, Class<T> expectedType) {
		...
		if (val == null)
			return null;
		if (expectedType.isAssignableFrom(val.getClass()))

...
/**
 * A simple list which holds only weak references to the original objects. original_author Martin Entlicher Modified to Generic List, while the original is not Generic
 */

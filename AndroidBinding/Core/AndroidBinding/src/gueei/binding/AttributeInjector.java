...
/**
 * Helper method to inject attributes to the given View or View collections It is supposed to do after the view is inflated, parsed and created view binding map, but before actual
 * binding occurs
 * 
 * @author andy
 * 
...
public class AttributeInjector {
	...
	/**
	 * Inject the given params to the whole tree of Views to the given root Since this is injection, the injecting parameters is always given higher priority and thus if existing
	 * attr is there, it will be overriden by injected value
	 * 
	 * @param params
	 * @param root
	 */

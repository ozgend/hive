...
public class AttributeBinder {
	...
	public boolean bindAttributeWithModel(Context context, View view, String viewAttributeName, String statement, Object model) {
	...
	public boolean bindAttributeWithObservable(Context context, View view, String viewAttributeName, IObservable<?> obs) {
		try {
			...
			if (result.equals(BindingType.NoBinding)) {
				BindingLog.warning("Binding Provider", "Observable: " + obs + ", cannot setup bind with attribute");
			}
			return true;
		} catch (AttributeNotDefinedException e) {
			BindingLog.exception("AttributeBinder.bindAttributeWithObservable()", e);

...
public class BindableTableLayout extends TableLayout implements IBindableView<BindableTableLayout> {
	...
	private ViewAttribute<BindableTableLayout, Object>	ItemSourceAttribute			= new ViewAttribute<BindableTableLayout, Object>(Object.class, BindableTableLayout.this, "ItemSource") {
																						@SuppressWarnings("unchecked")
																						@Override
	...
	private ViewAttribute<BindableTableLayout, Object>	RowChildAttribute			= new ViewAttribute<BindableTableLayout, Object>(Object.class, BindableTableLayout.this, "RowChild") {
																						@Override
																						protected void doSetAttributeValue(Object newValue) {
																							rowChild = null;
	...
	private ViewAttribute<BindableTableLayout, Boolean>	ItemUpdateEnabledAttribute	= new ViewAttribute<BindableTableLayout, Boolean>(Boolean.class, BindableTableLayout.this, "UpdateEnabled") {
																						@Override
																						protected void doSetAttributeValue(Object newValue) {
																							if (newValue == null) {
																								updateEnabled = true;
	...
	public ViewAttribute<BindableTableLayout, ?> createViewAttribute(String attributeId) {
		...
		if (attributeId.equals("rowChild"))
			return RowChildAttribute;
		if (attributeId.equals("updateEnabled"))
				...
				for (Object childItem : childItems) {
					...
					if (child != null) {
						...
						if (rowParams != null) {
							...
							margins.setMargins(rowParams.leftMargin, rowParams.topMargin, rowParams.rightMargin, rowParams.bottomMargin);

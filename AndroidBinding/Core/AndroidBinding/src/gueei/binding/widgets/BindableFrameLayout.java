...
public class BindableFrameLayout extends FrameLayout implements IBindableView<BindableFrameLayout> {
	...
	private ViewAttribute<?, Object>					LayoutIdViewAttribute		= new ViewAttribute<BindableFrameLayout, Object>(Object.class, BindableFrameLayout.this, "LayoutId") {
																						@Override
	...
	private ViewAttribute<?, Object>					DataSourceViewAttribute		= new ViewAttribute<BindableFrameLayout, Object>(Object.class, BindableFrameLayout.this, "DataSource") {
																						@Override
																						protected void doSetAttributeValue(Object newValue) {
	...
	private ViewAttribute<?, Command>					OnLoadAttribute				= new ViewAttribute<BindableFrameLayout, Command>(Command.class, BindableFrameLayout.this, "OnLoad") {
	...
	private ViewAttribute<BindableFrameLayout, Boolean>	ItemUpdateEnabledAttribute	= new ViewAttribute<BindableFrameLayout, Boolean>(Boolean.class, BindableFrameLayout.this, "UpdateEnabled") {
																						@Override
																						protected void doSetAttributeValue(Object newValue) {
																							if (newValue == null) {
																								updateEnabled = true;
	...
	public ViewAttribute<?, ?> createViewAttribute(String attributeName) {
		if (attributeName.equals("layoutId"))
			return LayoutIdViewAttribute;
		if (attributeName.equals("dataSource"))
			return DataSourceViewAttribute;
		if (attributeName.equals("onLoad"))
			return OnLoadAttribute;
		if (attributeName.equals("updateEnabled"))
			return ItemUpdateEnabledAttribute;

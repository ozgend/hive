...
public class Debugger {
	...
	public static void graphAttribute(ViewAttribute<?, ?> attr, int level, Printer printer, Object caller) {
		if (attr == null)
			return;
		if (printer == null)
			printer = new Printer(level);
	...
	public static void graphObservable(IObservable<?> observable, int level, Printer printer, Object caller) {
		if (observable == null)
			return;
		if (printer == null)
			printer = new Printer(level);
	...
	public static void graphObject(Object object, int level, Printer printer, Object caller) {
		if (object == null)
			return;
		if (printer == null)
			printer = new Printer(level);

...
/**
 * User: =ra= Date: 08.10.11 Time: 12:01
 */
public interface ICursorRowModel extends ILazyLoadRowModel {
	 ...
	 * 
	 * @param proposedId
	 *            can be ignored, invented for capability with collection based data sources where defaultId is an index or object in collection
